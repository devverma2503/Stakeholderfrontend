  ...
  return (
    <div className="bg-white rounded-xl shadow-md p-6">
      ...
      {isLoading ? (
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 md:grid-cols-2 sm:grid-cols-1">
          {/* Top Viewed Videos */}
              ...
              {videoData && videoData.length > 0 ? (
                videoData.map((video: any, index: number) => (
                  <div
                    ...
                    className="flex flex-col sm:flex-row sm:items-center sm:justify-between p-3 bg-gray-50 rounded-md hover:bg-gray-100 transition-colors"
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="font-medium text-gray-900 text-sm break-words">{video.title}</div>
                ...
                qbankData.map((module: any, index: number) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="font-medium text-gray-900 text-sm break-words">{module.name}</div>
                        <div className="flex flex-wrap items-center gap-2 text-xs text-gray-600 mt-1">
                          <span className="flex items-center gap-1">
