...
const StakeholderLayout: FC = () => {
    ...
    else if (selectedGroup === "printed-notes")
        filteredProducts = PRINTED_NOTES_PRODUCTS;
    ...
    if (normalizedZone.endsWith(" Zone"))
        normalizedZone = normalizedZone.replace(" Zone", "");
    if (selectedZone === "all") {
        filteredStates = Object.keys(STATE_ZONE_MAP);
    } else {
        filteredStates = Object.keys(STATE_ZONE_MAP).filter(
            (st) =>
                (STATE_ZONE_MAP as Record<string, string>)[st] ===
                normalizedZone
        );
    }
            ...
            <div className="flex w-full min-h-screen dark:bg-darkgray">
                ...
                <div className="page-wrapper flex flex-col flex-1">
                                ...
                                <div className="flex items-center justify-between w-full">
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-emerald-100 text-sm md:text-base hidden sm:block">
                    ...
                    <Drawer
                        ...
                        className="w-80 md:w-96 z-[9999]"
                        position="left"
                        aria-label="Stakeholder sidebar drawer"
                    >
