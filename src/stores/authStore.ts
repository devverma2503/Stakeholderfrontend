// Auth store disabled — commented out per request to remove authorization
/*
...
// Minimal no-op stub for useAuthStore to keep imports working while auth is disabled
const noopState = {
  user: null,
  colleges: null,
  accessToken: null,
...
export const useAuthStore = (() => {
  const fn: any = () => noopState;
  fn.getState = () => noopState;
  fn.setState = () => {};
  fn.subscribe = () => () => {};
  return fn;
})();
