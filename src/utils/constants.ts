...
export const UG_PRODUCTS = [
  'All UG-12months-all courses',
  'Basic Science Combo 6 Months',
  'Basic Sciences Combo',
  'Chatbot Product(C+TS+QBank)',
  'Clinical Combo',
  'Combo 1 - Medicine & Pediatrics ',
  'Combo 2 - Surgery & Orthopaedics',
  'Combo 3 - OBGYN & Pediatrics',
  'Combo - Microbiology & Pathology',
  'Combo - Microbiology + Pharmacology + Clinics',
  'Community Medicine for UnderGrads',
  'Cracking Nursing for Staff Selection',
  'DigiNEET',
  'DigiNEET 2 Months',
  'DigiNEET 3 Months',
  'DigiNEET Printed Notes',
  'DigiONE',
  'DigiTwo',
  'DigiTwo Printed Notes',
  'DOT Combo',
  'Forensic Medicine and Toxicology for UnderGrads',
  'Medicine For UnderGrad',
  'Medicine for UnderGrads',
  'Medicine for UnderGrads - 3 Months',
  'Microbiology for UnderGrads',
  'Microbiology for UnderGrads - 1 Month',
  'Microbiology for UnderGrads - 25 Days',
  'OBGYN 6 months-USD',
  'OBGYN for UnderGrads',
  'OBGYN for UnderGrads - 7 Days',
...
export const PG_PRODUCTS = [
  ...
  'Critical Care Simplified - 12 months',
  'Critical Care Simplified - 24 months',
  'Dermatology MD',
  'Dermatology MD 24 months',
  'Dermatology MD Printed Notes',
  'Ganga Videos on Spine Surgery',
  'Medicine MD',
  'Medicine MD old',
  'Medicine MD Printed Notes',
  'MRCOG Part 1 Grand Mock Test',
  'MRCOG Part 1 Online Resources',
  'MRCOG Part 2 Grand Mock Test',
  'Musculoskeletal Examination',
  'OBGYN MD',
  'OBGYN MD-12 months free',
  'OBGYN MD old',
  'OBGYN MD Printed Notes',
  'OBGYN MD - SM',
  'Ophthalmology MD',
  'Ophthalmology MD - 12 month',
  'Ophthalmology MD - 18 month',
  'Ophthalmology MD - 24 month',
  'Ophthalmology MD - 36 month',
  'Ophthalmology MD Printed Notes',
  'Organ Donation Simplified',
  'Orthopedics MS',
  'Orthopedics MS Printed Notes',
  'Pathology For UnderGrad',
  'Pediatrics MD Book Bundle',
  'Pediatrics MD Printed Notes',
  'Pediatrics MD (Residency + NEET SS)',
  'Surgery MS (Residency + NEET SS)',
  'Surgery Printed Notes',
  'Ultrasound in OBGYN Made Easy',
];
export const PRINTED_NOTES_PRODUCTS = [
  'Dermatology MD Printed Notes',
  'DigiNEET Printed Notes',
  'DigiTwo Printed Notes',
  'Medicine MD Printed Notes',
...
export const STATE_ZONE_MAP = {
  'Chhattisgarh': 'West',
  'Dadra and Nagar Haveli (Daman)': 'West',
  'Goa': 'West',
  'Gujarat': 'West',
  'Madhya Pradesh': 'West',
  'Maharashtra': 'West',
