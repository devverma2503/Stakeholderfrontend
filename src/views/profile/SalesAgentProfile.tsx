...
const SalesAgentProfile = ({ agentId = "1" }: SalesAgentProfileProps) => {
    ...
    const calculateGrowthRate = () => {
        const currentYear =
            yearlyRevenueData[yearlyRevenueData.length - 1].revenue;
        const previousYear =
            yearlyRevenueData[yearlyRevenueData.length - 2].revenue;
                    ...
                    <div className="flex items-center justify-between mb-6">
                        <div>
                            ...
                            <p className="text-gray-600 text-sm">
                                Revenue growth trend over years
                            </p>
                        </div>
                ...
                <div className="bg-white rounded-xl shadow-md p-6">
                    <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-6 gap-4">
                        <div>
                            ...
                            <p className="text-gray-600 text-sm">
                                Sales breakdown by course categories
                            </p>
                        </div>
